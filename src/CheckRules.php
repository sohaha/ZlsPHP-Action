        ...
        return [
            ...
            'unique' => function ($key, $value, $data, $args, &$returnValue, &$break, &$db) {
                ...
                if (Z::arrayKeyExists(1, $args)) {
                    ...
                    $id_col = $_id_info[0];
                    $id = $_id_info[1];
                    $id = 0 === stripos($id, '#') ? Z::getPost(substr($id, 1)) : $id;
            ...
            'range' => function ($key, $value, $data, $args, &$returnValue, &$break, &$db) {
                ...
                $v = (array)$value;
                foreach ($v as $value) {
                    $okay = (2 == count($args)) && is_numeric($value) ? $value >= $args[0] && $value <= $args[1] : false;
                    if (!$okay) {
                        return false;
                    }
                }
            ...
            'chs' => function ($key, $value, $data, $args, &$returnValue, &$break, &$db) {
                ...
                $can_empty = Z::arrayKeyExists(0, $args) && 'true' == $args[0];
                $v = (array)$value;
                foreach ($v as $value) {
                    $okay = !empty($value) ? preg_match(
